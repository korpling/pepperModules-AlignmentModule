...
import org.corpus_tools.peppermodules.alignment.AlignmentImporter;
 ...
 * {@link AlignmentImporter} class. Feel free to adapt and enhance this test class
 ...
 * @author Martin Klotz
 */
public class AlignmentImporterTest extends PepperImporterTest {
	/**
	...
	@Before
	public void setUp() {
		setFixture(new AlignmentImporter());
	...
	public void test_DummyImplementation() {
		...
		getFixture().getCorpusDesc().setCorpusPath(getTempURI("AlignmentImporter"));
