 ...
 * @author Martin Klotz
 */
@Component(name = "AlignmentImporterComponent", factory = "PepperImporterComponentFactory")
public class AlignmentImporter extends PepperImporterImpl implements PepperImporter{
	/** this is a logger, for recording messages during program process, like debug messages**/
	private static final Logger logger = LoggerFactory.getLogger(AlignmentImporter.class);
	 ...
	 * sample mapper of type {@link AlignmentMapper}, which only produces a fixed
	 * document-structure in method {@link AlignmentMapper#mapSDocument()} and
	 * enhances the corpora for further meta-annotations in the method
	 * {@link AlignmentMapper#mapSCorpus()}. <br/>
	 ...
	 * {@link AlignmentMapper#mapSDocument()} and enhances the corpora for further
	 * meta-annotations in the method {@link AlignmentMapper#mapSCorpus()}. <br/>
	 ...
	 *
	 */
	public static class AlignmentMapper extends PepperMapperImpl {
		/**
		 * <strong>OVERRIDE THIS METHOD FOR CUSTOMIZATION</strong> <br/>
